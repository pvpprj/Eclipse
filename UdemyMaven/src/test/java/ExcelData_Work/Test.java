...
public class Test {
	...
	public static void main(String[] args) throws InterruptedException, IOException, TesseractException {
		...
		/*File src = driver.findElement(By.xpath("//div[@id='nlpImgContainer']//div//div//div//div//img")).getScreenshotAs(OutputType.FILE);
	...
	//	WebElement er = driver.findElement(By.xpath("//div[@class='loginError']"));
		WebElement er = driver.findElement(By.className("loginError"));
