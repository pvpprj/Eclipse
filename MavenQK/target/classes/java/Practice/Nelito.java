...
public class Nelito {
	...
	public static void main(String[] args) {
		...
		WebElement newlead=driver.findElement(By.xpath("//*[@id=\"tot\"]"));
		
		String leadno = "LEAD219";
		By leads = By.xpath("//*[@id='Doc_Check_Lst1']/tbody/tr[17]/td[1]/a");
	                         
		WebElement leads1 = newlead.findElement(leads); // highLightElement(driver,submit1);
	    leads1.click();
	    
		//	WebElement newlead=driver.findElement(By.cssSelector("#Doc_Check_Lst1"));
