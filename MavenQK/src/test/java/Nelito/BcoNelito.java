...
public class BcoNelito {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		dashboard.click();
		Thread.sleep(2000);
		WebElement LeadMenu	= driver.findElement(By.xpath("//h2[@id='h29']"));
		LeadMenu.click();
		Thread.sleep(2000);
	    ...
	    WebElement Remark =driver.findElement(By.xpath("//textarea[@id='RECOM_REMARK']"));
	    Remark.sendKeys("PASS");
		Thread.sleep(2000);
		System.out.println(" Remark Enter ");
		
	  WebElement process = driver.findElement(By.xpath("//input[@id='APPROVE']"));
	    process.click();
		Thread.sleep(2000);
